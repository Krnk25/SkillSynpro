...
<header>
    ...
    <nav class="navbar" id="nav-menu">
        <ul>
            ...
            <li class="<?= basename($_SERVER['PHP_SELF'])=='upload-resume.php'?'active':'' ?>"><a
                    href="upload-resume.php">Upload Resume</a></li>
            <li class="<?= basename($_SERVER['PHP_SELF'])=='student-jobs.php'?'active':'' ?>"><a
                    href="student-jobs.php">Jobs</a></li>
            <li class="<?= basename($_SERVER['PHP_SELF'])=='subscription.php'?'active':'' ?>"><a
                    href="subscription.php">Subscription</a></li>
